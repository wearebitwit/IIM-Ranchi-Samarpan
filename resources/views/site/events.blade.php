...
<div class="clearfix"></div>
    ...
    <section class="event-header2" id="funathon">
        <div class="container">
            <div class="row">
...
-->
    ...
    <section id="media">
        ...
        <div class="container">
            <div class="row competition">
                <div class="col-md-12">
                    <h2>Selfie SuperStar </h2>
                    <p>Take 1 selfie each with the 4 big Art Structures (capturing the essence of the individual events – Radix, Funathon, Excelsior and the umbrella of Nirvaadh). These structures will be placed at the events venues during 6-7 February 2016 and post them on FB, Twitter and Linkedin. The one who attains the maximum number of cumulative likes will be the Selfie SuperStar
                        <br>
                        <br>
                    ...
                    <div class="col-md-12">
                        ...
                        <p>Individual entry.<br>
                            Only one entry is allowed per participant.<br>
                            The participant will take 1 selfie each with the 4 big Art Structures (capturing the essence of Radix, Funathon, Excelsior and Nirvaadh respectively) placed at the events venues during 6-7 February 2016 and post them on FB, Twitter and Linkedin. The one who attains the maximum number of cumulative likes will be the Selfie SuperStar<br>

                            Register yourself (link) and then Email us your photographs (soft copy), along with the links to your facebook, twitter and Linkedin posts of these photographs, at samarpan@iimranchi.ac.in before February 7, 2016 (23:59:59)<br>

                            Naming convention for E-mail subject: “Nirvaadh || Selfie SuperStar || Individual Name || Institute Name<br>
                            Naming convention for Selfie with the main Nirvaadh creative: “Nirvaadh || Selfie SuperStar - Nirvaadh || Individual Name || Institute Name<br>
                            Naming convention for Selfie with the Radix creative: “Nirvaadh || Selfie SuperStar - Radix || Individual Name || Institute Name<br>
                            Naming convention for Selfie with the Funathon creative: “Nirvaadh || Selfie SuperStar - Funathon || Individual Name || Institute Name<br>
                            Naming convention for Selfie with the Excelsior creative: “Nirvaadh || Selfie SuperStar - Excelsior || Individual Name || Institute Name
            ...
            <div class="row competition">
                <div class="col-md-12">
                    <h2>Novus</h2>
                    <p>The participant has to attain maximum likes on her/his update on FB, Twitter and Linkedin about her/his participation in a particular event in a pre-defined format, which will include the event name and the sponsors’ name.
                        <br>
                        <br>
                    ...
                    <div class="col-md-12">
                        <h3>Rules</h3>
                        <p>Be Novus. Be new. Be innovative.<br>
                            Individual entry.<br>
                            Only one entry is allowed per participant per competition.<br><br>
                            The participant has to attain maximum likes on her/his update on FB, Twitter and Linkedin about her/his participation in a particular event in a pre-defined format, which will include the event name and the sponsors’ name.<br>


                            Register yourself (link) and then Email us the links to your post about your participation in a particular competition in the below mentioned format, at samarpan@iimranchi.ac.in before February 7, 2016 (23:59:59)<br>

                            Format for post about participation:<br>
                            I am glad to be participating in Nirvaadh (link), 2016 through Name of the competition<br>
                            [POSTER OF NIRVAADH] [POSTER OF THE COMPETITION]<br>
            ...
            <div class="row competition">
                <div class="col-md-12">
                    <h2>Hermes for Nirvaadh</h2>
                    <p>The participant has to attain maximum likes and share and ReTweets on 4 particular event updates about Nirvaadh, Radix, Funathon and Excelsior respectively, on the 3 social media platforms – FB, Twitter, Linkedin.
                    ...
                    <div class="col-md-12">
                        ...
                        <p>Be the Hermes for Nirvaadh <br>
                            Individual entry. <br>
                            Only one entry is allowed per participant per competition. <br>
                            The participant has to attain maximum likes and share and ReTweets on 4 particular event updates about Nirvaadh, Radix, Funathon and Excelsior respectively, on the 3 social media platforms – FB, Twitter, Linkedin. <br>

                            Register yourself (link) and then Email us the links to your post where you shared the official posters of Nirvaadh on your timeline at samarpan@iimranchi.ac.in before February 7, 2016 (23:59:59) <br>
            ...
            <div class="row competition">
                <div class="col-md-12">
                    <h2>Nirvaadh Cup – Athena</h2>
                    <p>This cup will be awarded to the institute, which has maximum participation in Nirvaadh through competitions and through events.
                ...
                <br>
                    ...
                    <div class="col-md-12">
                        ...
                        <p>Score given to an institute’s representation in any of the 8 main competitions: 2 points for each representative per competition. <br>
                            For eg.- Institute X will have a score of 6 if it has 3 students participating in one competition. Moreover, if the students participate in multiple competitions then each of their participation will be counted separately.  Thus, if a student participates in 2 different competitions, then this will give the institute 4 points.<br>
                            Score given to an institute’s representation in any of the 3 events: 2 for each event<br>
                            Similarly,<br>
                            Score given to an institute’s representation in any of the 3 events: 2 for each event<br>
            ...
            <div class="row competition">
                <div class="col-md-12">
                    <h2>Nirvaadh Cup – Midas</h2>
                    <p>This cup will be awarded to the company, which has maximum participation in Nirvaadh through the 3 events – Radix, Funathon and Excelsior.
                ...
                <br>
                    ...
                    <div class="col-md-12">
                        ...
                        <p>Score given to a company’s representation in any of the 3 events (Radix, Funathon and Excelsior): 2 for each event<br>
                            For eg.- Company X will have a score of 6 if it has 3 employees participating in one event. Moreover, if the students participate in multiple events then each of their participation will be counted separately.  Thus, if an employee participates in 2 different events, then this will give the company 4 points.<br>
                            The company with the maximum representation will be awarded with the Nirvaadh Cup - Midas
            ...
            <div class="row competition">
                <div class="col-md-12">
                    <h2>The True Nirvaadhi Award</h2>
                    <p>This award will be given to the individual, who has maximum participation in Nirvaadh through competitions and through events.
                    ...
                    <div class="col-md-12">
                        <h3>Rules</h3>
                        <p>Score given to an individual’s representation in any of the 8 main competitions: 2 points for each representative per competition. <br>
                            Score given to an individual’s representation in any of the 3 events (Radix, Funathon and Excelsior): 2 for each event
                            For eg.- if a person participates in 2 different competitions, then this will give her/him 4 points. Similarly, if a person participates in 1 competition and 3 events then the person will have a total of 8 points.<br>
                            The aim is to maximize these points.<br>
            ...
            <div class="row competition">
                <div class="col-md-12">
                    <h2>Nirvaadh Quiz</h2>
                    <p>Online quiz of 10 questions about Nirvaadh, to be held on 3 consecutive days – 5th, 6th and 7th February 2016
                    ...
                    <div class="col-md-3">
                        ...
                        <p>Registration: till one hour before the quiz starts<br>
                            Declare Results - The next morning of the quiz</p>
                    </div>
                    <div class="col-md-3">
                        <h3>Prizes</h3>
                        <p>Winner: Rs. 500/-<br>
                    ...
                    <div class="col-md-12">
                        <h3>Rules</h3>
                        <p>4 days - From 5-8 February 2016<br>
                            Duration of the quiz: 7min.<br>
                            Quiz about Nirvaadh<br>
                            10:40 – 11 p.m. (5th, 6th, 7th, 8th February 2016)<br>
                            10 questions per quiz<br>
                            Register before 10:15 pm. Before every quiz<br>
            ...
            <div class="row competition">
                <div class="col-md-12">
                    ...
                    <div class="col-md-3">
                        <h3>Prizes</h3>
                        <p>BYOB Winner: Rs. 500/-<br>
                            BattleBots Winner: Rs. 500/-<br>
                            Short Film Winner: Rs. 500/-<br>
    ...
    <section class="event-header3" id="team">
        <div class="container">
            <div class="row">
                <h2>Team Nirvaadh</h2>
                <p class="centered">"the<strong> aces</strong> behind the scene"</p>
                <br>

                <h2 >Chief-Organizers – entire Nirvaadh</h2>
                <div class="team-samarpan row">
                    <h3>Team Samarpan – the CSR club of IIM Ranchi</h3>
                    <div class="col-sm-3">
                        <img class="img-responsive" src="images/team/Shelly_Singh.jpg">
                        <p>Shelly Singh<br>
                            Senior coordinator – Samarpan Club<br>
                            Email-id: shelly.singh14@iimranchi.ac.in</p>
                    </div>
                    <div class="col-sm-3">
                        <img class="img-responsive" src="images/team/Pratishruti%20JAin.jpg">
                        <p>Pratishruti Jain<br>
                            Coordinator – Samarpan club<br>
                            Ph: +91- 9632597603<br>
                            Email-id: pratishruti.j15@iimranchi.ac.in</p>
                    </div>
                    <div class="col-sm-3">
                    ...
                    <div class="col-sm-3">
                        <img class="img-responsive" src="images/team/athina.jpg">
                        <p>Athina<br>
                            Coordinator – Samarpan club<br>
                            Ph: +91- 7091098550<br>
                            Email-id: chau.chauhai15@iimranchi.ac.in</p>
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-sm-3 col-sm-offset-3">
                    ...
                    <p>Suleman Safdar<br>
                        ...
                        Email-id: suleman.safdar14@iimranchi.ac.in</p>
                </div>
                <div class="col-sm-3">
                    <img class="img-responsive" src="images/team/Abhishek%20Gupta.jpg">
                    <p>Abhishek Gupta<br>
            ...
            <div class="row">
                <h2>Funathon and Excelsior : Samarpan Club in association with Sankriya Club</h2>
                ...
                <div class="col-sm-3 col-sm-offset-1">
                    ...
                    <p>Rupesh Kumar<br>
                        ...
                        Email-id: rupesh.kumar14@iimranchi.ac.in</p>
                </div>

                <div class="col-sm-3">
                    <img class="img-responsive" src="images/team/Anushka_Chowdhury.JPG">
                ...
                <div class="col-sm-3">
                    ...
                    <p>Saswata Banerjee<br>
                        Coordinator – Sankriya club<br>
                        Ph: +91-9049570470<br>
                        Email-id: saswata.banerjee15@iimranchi.ac.in</p>
                </div>
                <div class="clearfix"></div>
                <br>
                <div class="col-sm-3 col-sm-offset-3">
                    <img class="img-responsive" src="images/team/Vamshi%20Kumar.JPG">
                    <p>Vamshi<br>
                        Coordinator – Sankriya club<br>
                        Ph: +91- 8139987213<br>
                        Email-id: s.vamshi15@iimranchi.ac.in</p>
                </div>
                <div class="col-sm-3">
                    <img class="img-responsive" src="images/team/Nitin%20Arora.jpg">
                    <p>Nitin Arora<br>
                        Coordinator – Sankriya club<br>
                        Ph: +91- 9810520870<br>
                        Email-id: nitin.arora15@iimranchi.ac.in</p>
                </div>
            </div>

            <hr class="divider">
            <div class="row">
                <h2>Creatives Team</h2>
                <br>
                <div class="col-sm-3 col-sm-offset-2">
                    <img class="img-responsive" src="images/team/Sonal%20Jain.jpeg">
                    <p>Sonal Jain<br>
                        Head – Creatives<br>
                        Interior Designing Student at IVS School of Design<br>
                        Email-id: sonaljdesigner@gmail.com</p>
                </div>
                <div class="col-sm-3">
                    <img class="img-responsive" src="images/team/Prabhat%20Ranjan.jpg">
                    <p>Prabhat Ranjan<br>
                        Email-id: prabhat.ranjan14@iimranchi.ac.in</p>
                </div>
                <div class="col-sm-3">
                    <img class="img-responsive" src="images/team/Ashita%20Dhir.jpg">
                    <p>Ashita Dhir<br>
                        Email-id: ashita.dhir14@iimranchi.ac.in</p>
                </div>
            </div>
            <hr class="divider">
            <div class="row">
                ...
                <br>
                <div class="col-sm-3 col-sm-offset-3">   
                    <img class="img-responsive" src="images/team/Anant.jpg">
                    <p>Anant Garg<br>
                        Web Artist<br>
                        Email-id: infinitegarg@gmail.com</p>
                </div>
                <div class="col-sm-3">
                    <img class="img-responsive" src="images/team/nikhil.jpg">
                    <p>Nikhil Srivastava<br>
                        Web Developer<br>
                        Email-id: niksrc@gmail.com</p>
                </div>
            </div>
        </div>    
    </section>
    ...
    <section class="event-header3" id="sponsors">
        <div class="container">
            <div class="row">
                <h2>Sponsors</h2>
