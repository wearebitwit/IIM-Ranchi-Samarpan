...
<body>
  ...
  <!-- Pen Title-->
  <div class="pen-title">
    <h1>Garage</h1><span> <i class='fa fa-code'></i> for <a href='http://www.iimsamarpan.com'>IIM Samarpan</a></span>
  </div>
  <div class="container">
    <div class="card"></div>
    <div class="card">
    ...
    <div class="card alt">
      ...
      <form method="POST" action="/garage/auth">
        <div class="input-container">
        ...
        <div class="input-container">
          <input type="password" id="Repeat Password" name="password_confirmation" required="required"/>
